...
export const MESSAGES: Record<string, Record<string, string>> = {
  ...
  en: {
    ...
    BOOKS_CONFIRM_PROMPT: `Got it!\n\n{type}: R{amount}\nFor: {desc}\n\nReply YES to save or NO to cancel.`,
    BOOKS_TYPE_INCOME: `Income`,
    BOOKS_TYPE_EXPENSE: `Expense`,
    BOOKS_INVALID_AMOUNT: `Please enter a valid amount (e.g. 150)`,
    BOOKS_SAVE_FAILED: `Could not save — business not found.\n\nType *MENU* to go back.`,
    BOOKS_SAVE_SUCCESS: `✅ {type} of R{amount} saved!\n\n1️⃣ Capture Income\n2️⃣ Capture Expense\n3️⃣ Main Menu`,
    BOOKS_SAVE_CANCELLED: `Cancelled.\n\n1️⃣ Capture Income\n2️⃣ Capture Expense\n3️⃣ Main Menu`,
    LOG_SAVED:      `✅ Saved!\n\n1️⃣ Capture Income\n2️⃣ Capture Expense\n3️⃣ Main Menu`,
    ...
    STORE_MENU:     `🛒 *KasiStore*\n\n1️⃣ Add a product\n2️⃣ View my products\n3️⃣ Get my store link\n\nType *MENU* to go back.`,
    STORE_ADD_NAME: `📦 What's the name of the product?`,
    STORE_ADD_PRICE: `💰 What's the price? (e.g. 150)`,
    STORE_ADD_DESC: `📝 Add a short description (or type SKIP)`,
    STORE_INVALID_PRICE: `Please enter a valid price (e.g. 150)`,
    CREDIT_MENU:    `💰 *KasiCredit — Apply for a Loan*\n\n1️⃣ Check my eligibility\n2️⃣ Apply now\n\nType *MENU* to go back.`,
  ...
  zu: {
    ...
    BOOKS_CONFIRM_PROMPT: `Kuyavunyelwa!\n\n{type}: R{amount}\nNgokwe: {desc}\n\nPhendula u-YES ukuze ulondoloze noma u-NO ukuze ukhanseli.`,
    BOOKS_TYPE_INCOME: `Imali engenayo`,
    BOOKS_TYPE_EXPENSE: `Indleko`,
    BOOKS_INVALID_AMOUNT: `Sicela ufake inani elivumelekile (isib. 150)`,
    BOOKS_SAVE_FAILED: `Ayikwazanga ukulondoloza — ishishini alitholakali.\n\nThayipha *MENU* ukubuya.`,
    BOOKS_SAVE_SUCCESS: `✅ {type} ye-R{amount} ilondoloziwe!\n\n1️⃣ Rekhoda imali engenayo\n2️⃣ Rekhoda indleko\n3️⃣ Imenyu Eyinhloko`,
    BOOKS_SAVE_CANCELLED: `Kukhanselwe.\n\n1️⃣ Rekhoda imali engenayo\n2️⃣ Rekhoda indleko\n3️⃣ Imenyu Eyinhloko`,
    ...
    STORE_MENU:     `🛒 *KasiStore*\n\n1️⃣ Faka umkhiqizo\n2️⃣ Buka imikhiqizo yami\n3️⃣ Thola isixhumanisi sesitolo sami\n\nThayipha *MENU* ukubuya.`,
    STORE_ADD_NAME: `📦 Ngubani igama lomkhiqizo?`,
    STORE_ADD_PRICE: `💰 Yimalini? (isib. 150)`,
    STORE_ADD_DESC: `📝 Faka incazelo emfushane (noma thayipha SKIP)`,
    STORE_INVALID_PRICE: `Sicela ufake inani elivumelekile (isib. 150)`,
    CREDIT_MENU:    `💰 *KasiCredit — Cela Imalimboleko*\n\n1️⃣ Hlola ukufaneleka kwami\n2️⃣ Faka isicelo manje\n\nThayipha *MENU* ukubuya.`,
  ...
  xh: {
    ...
    BOOKS_CONFIRM_PROMPT: `Siyavuma!\n\n{type}: R{amount}\nNgokwe: {desc}\n\nPhendula u-YES ukuze ugcine okanye u-NO ukuze urhoxe.`,
    BOOKS_TYPE_INCOME: `Imali engena`,
    BOOKS_TYPE_EXPENSE: `Indleko`,
    BOOKS_INVALID_AMOUNT: `Nceda ufake isixa esivumelekileyo (umz. 150)`,
    BOOKS_SAVE_FAILED: `Ayikwazanga ukugcina — ishishini alifunyanwanga.\n\nTayipha *MENU* ukubuyela.`,
    BOOKS_SAVE_SUCCESS: `✅ {type} ye-R{amount} igciniwe!\n\n1️⃣ Gcina imali engena\n2️⃣ Gcina indleko\n3️⃣ Imenyu Eyinhloko`,
    BOOKS_SAVE_CANCELLED: `Kurhoxisiwe.\n\n1️⃣ Gcina imali engena\n2️⃣ Gcina indleko\n3️⃣ Imenyu Eyinhloko`,
    LOG_SAVED:      `✅ Kugcinwe!\n\n1️⃣ Gcina imali engena\n2️⃣ Gcina indleko\n3️⃣ Imenyu Eyinhloko`,
    ...
    STORE_MENU:     `🛒 *KasiStore*\n\n1️⃣ Yongeza imveliso\n2️⃣ Jonga iimveliso zam\n3️⃣ Fumana ikhonkco levenkile yam\n\nTayipha *MENU* ukubuyela.`,
    STORE_ADD_NAME: `📦 Ngubani igama lemveliso?`,
    STORE_ADD_PRICE: `💰 Yimalini? (umz. 150)`,
    STORE_ADD_DESC: `📝 Faka inkcazelo emfutshane (okanye tayipha SKIP)`,
    STORE_INVALID_PRICE: `Nceda ufake ixabiso elivumelekileyo (umz. 150)`,
    CREDIT_MENU:    `💰 *KasiCredit — Cela Imboleko*\n\n1️⃣ Jonga ukufaneleka kwam\n2️⃣ Faka isicelo ngoku\n\nTayipha *MENU* ukubuyela.`,
  ...
  st: {
    ...
    BOOKS_CONFIRM_PROMPT: `Ho lokile!\n\n{type}: R{amount}\nKa: {desc}\n\nAraba YES ho boloka kapa NO ho hlakola.`,
    BOOKS_TYPE_INCOME: `Chelete e kena`,
    BOOKS_TYPE_EXPENSE: `Ditshenyehelo`,
    BOOKS_INVALID_AMOUNT: `Ka kopo kenya chelete e nepahetseng (mohlala 150)`,
    BOOKS_SAVE_FAILED: `Ha e kgone ho boloka — kgwebo ha e fumanehe.\n\nTaepa *MENU* ho kgutla.`,
    BOOKS_SAVE_SUCCESS: `✅ {type} ya R{amount} e bolokiloe!\n\n1️⃣ Ngola chelete e kena\n2️⃣ Ngola ditshenyehelo\n3️⃣ Menyu Ea Mantlha`,
    BOOKS_SAVE_CANCELLED: `Ho hlaotswe.\n\n1️⃣ Ngola chelete e kena\n2️⃣ Ngola ditshenyehelo\n3️⃣ Menyu Ea Mantlha`,
    ...
    STORE_MENU:     `🛒 *KasiStore*\n\n1️⃣ Kenya thepe\n2️⃣ Sheba thepe ya ka\n3️⃣ Fumana linki ya lebenkele la ka\n\nTaepa *MENU* ho kgutla.`,
    STORE_ADD_NAME: `📦 Lebitso la thepe ke mang?`,
    STORE_ADD_PRICE: `💰 Ke bokae? (mohlala 150)`,
    STORE_ADD_DESC: `📝 Kenya tlhaloso e kgutshwane (kapa taepa SKIP)`,
    STORE_INVALID_PRICE: `Ka kopo kenya chelete e nepahetseng (mohlala 150)`,
    CREDIT_MENU:    `💰 *KasiCredit — Kopa Mpho-Kadimo*\n\n1️⃣ Hlahloba ho tshwaneleha ha ka\n2️⃣ Kopa jwale\n\nTaepa *MENU* ho kgutla.`,
  ...
  af: {
    ...
    BOOKS_CONFIRM_PROMPT: `Duidelik!\n\n{type}: R{amount}\nVir: {desc}\n\nAntwoord YES om te stoor of NO om te kanselleer.`,
    BOOKS_TYPE_INCOME: `Inkomste`,
    BOOKS_TYPE_EXPENSE: `Uitgawe`,
    BOOKS_INVALID_AMOUNT: `Tik asseblief 'n geldige bedrag in (bv. 150)`,
    BOOKS_SAVE_FAILED: `Kon nie stoor nie — besigheid nie gevind nie.\n\nTik *MENU* om terug te gaan.`,
    BOOKS_SAVE_SUCCESS: `✅ {type} van R{amount} is gestoor!\n\n1️⃣ Teken inkomste aan\n2️⃣ Teken uitgawe aan\n3️⃣ Hoofkieslys`,
    BOOKS_SAVE_CANCELLED: `Gekanselleer.\n\n1️⃣ Teken inkomste aan\n2️⃣ Teken uitgawe aan\n3️⃣ Hoofkieslys`,
    LOG_SAVED:      `✅ Gestoor!\n\n1️⃣ Teken inkomste aan\n2️⃣ Teken uitgawe aan\n3️⃣ Hoofkieslys`,
    ...
    STORE_MENU:     `🛒 *KasiStore*\n\n1️⃣ Voeg 'n produk by\n2️⃣ Sien my produkte\n3️⃣ Kry my winkelskakel\n\nTik *MENU* om terug te gaan.`,
    STORE_ADD_NAME: `📦 Wat is die naam van die produk?`,
    STORE_ADD_PRICE: `💰 Wat is die prys? (bv. 150)`,
    STORE_ADD_DESC: `📝 Voeg 'n kort beskrywing by (of tik SKIP)`,
    STORE_INVALID_PRICE: `Tik asseblief 'n geldige prys in (bv. 150)`,
    CREDIT_MENU:    `💰 *KasiCredit — Doen Aansoek vir 'n Lening*\n\n1️⃣ Kyk of ek kwalifiseer\n2️⃣ Doen nou aansoek\n\nTik *MENU* om terug te gaan.`,
  ...
  ve: {
    ...
    LOG_DESC:       `Ndi ya mini? (e.g. "Khuhu X3")`,
    BOOKS_CONFIRM_PROMPT: `Ndo zwi wana!\n\n{type}: R{amount}\nNdi ya: {desc}\n\nKha vha ṅwale Ee u itela u vhulunga kana NO u khansela.`,
    BOOKS_TYPE_INCOME: `Income (Tshelede yo dzhenaho)`,
    BOOKS_TYPE_EXPENSE: `Expense (Tshelede yo bvaho)`,
    BOOKS_INVALID_AMOUNT: `Kha vha lulamise tshelede ye vha ṅwala (e.g. 150)`,
    BOOKS_SAVE_FAILED: `Bindu ḽavho aḽi khou wanala, ari nga do vhulunga\n\nKha vha ṅwale *MENU* u humela murahu.`,
    BOOKS_SAVE_SUCCESS: `✅ {type} ya R{amount} yo vhulungwa!\n\n1️⃣ 💚 Income (Tshelede yo dzhenaho)\n2️⃣ 🔴 Expense (Tshelede yo bvaho)\n3️⃣ Main Menu`,
    BOOKS_SAVE_CANCELLED: `Ro khansela.\n\n1️⃣ 💚 Income (Tshelede yo dzhenaho)\n2️⃣ 🔴 Expense (Tshelede yo bvaho)\n3️⃣ Main Menu`,
    LOG_SAVED:      `✅ Ro rekhoda!\n\n1️⃣ 💚 Income (Tshelede yo dzhenaho)\n2️⃣ 🔴 Expense (Tshelede yo bvaho)\n3️⃣ Main Menu`,
    LOG_CANCEL:     `Ro khansela.\n\n1️⃣ 💚 Income (Tshelede yo dzhenaho)\n2️⃣ 🔴 Expense (Tshelede yo bvaho)\n3️⃣ Main Menu`,
    COMPLY_MENU:    `📊 *KasiComply — Muthelo na u tevhedza milayo*\n\n1️⃣ Kha vha sedze arali vha tshi fanelwa nga *muthelo wa mveledziso* (Turnover Tax) ?\n2️⃣ Kha vha vhalele muthelo wa bindu lavho\n3️⃣ Kha vha vhone khalenda yavho ya muthelo\n4️⃣ PAYE & mbadelo dza vhashumi\n5️⃣ Maduvha a u vala ane a khou sendela\n\nkha vha ṅwale *MENU* u humela murahu.`,
    TT_Q1:          `📋 *Turnover Tax Qualifier*\n\nMbudziso 1 ya 3:\n\nNga u tou anganyela bindu lavho li dzhenisa vhugai nga nwaha?\n\nKha vha ṅwale tshelede. (e.g. 450000)`,
    TT_Q2:          `Mbudziso 2 ya 3:\n\nVha na mabindu ano fhira ḽithihi?\n\n1️⃣ Hai — Ndi ḽithihi fhedzi\n2️⃣ Ee — Ndi na maṅwe mabindu`,
    TT_Q3:          `Mbudziso 3 ya 3:\n\nKhethekanyo ya bindu ḽavho ndi *khamphani ya tshitshavha / public company*?\n\n1️⃣ Hai — Ndi bindu ḽi tuku ḽa phuraivethe\n2️⃣ Ee — Ndi khampani ya tshitshavha`,
    TT_QUALIFIES:   `✅ *Mafhungo a vhudi! Vha tendelwa u badela muthelo wa mveledziso /Turnover Tax.*\n\nMuthelo wa mveledziso (Turnover Tax) u dzhiela vhudzulo mithelo miraru  yo fhambanaho nga mbadelo nthihi yo leluwaho ya ṅwaha.\n\nMuthelo wo anganyelwaho: *{amount}*\nDuvha ḽa u fhedzisa u badela ndi dzi 28 dza Luhuhi/February.\n\n1️⃣ Vha nwalisa hani?\n2️⃣ Khari vhalele tshelede ya vhukuma\n3️⃣ Humela murahu kha *MENU*`,
    TT_NOT_QUALIFY: `ℹ️ A vha tendelwi u badela muthelo wa mveledziso (Turnover Tax).\n\nTshiitisi: {reason}\n\n1️⃣ Kha vha gude nga ha muthelo wa nzudzanyo\n2️⃣ U humela murahu kha *MENU*`,
    TT_HOW_REGISTER:`📝 *U Nwalisa muthelo wa mveledziso /Turnover Tax*\n\n1. Kha vha dzhene kha sars.gov.za\n2. Kha vha dzhene kha eFiling\n3. Khethani "Register for Turnover Tax"\n4. Kha vha wane fomo ya TT01\n\n✅ U ṅwalisa a zwi na mbadelo.\n\nKha vha ṅwale *MENU* u humela murahu.`,
    CALC_Q1:        `💰 *Kha ri vhalele Muthelo*\n\nTshelede yavho yo dzhenaho nga nwedzi ndi ngafhi?\n\n(e.g. 12500)`,
    CALC_Q2:        `Tshelede yo bvaho nga ṅwedzi ndi vhugai?\n\n(e.g. 4200)\n kha vha ṅwale 0 arali hu sina tshelede yo bvaho.`,
    CALC_RESULT:    `📊 *Muvhigo wa Muthelo*\n\n💚 Tshelede yo dzhenaho: R{income}\n🔴 Tshelede yo bvaho: R{expenses}\n📈 Mbuyelo: R{profit}\n\n*Muthelo Wo Anganyelwaho*\n{tax_detail}\n\nKha vha ṅwale *MENU* u humela murahu.`,
    PAYE_Q1:        `👥 *PAYE Calculator*\n\nVha na vhashumi vhangana?`,
    PAYE_Q2:        `Vho badela vhugai ya vha shumi yo ṱangana nga ṅwedzi?\n\n(e.g. 8500)`,
    PAYE_RESULT:    `💼 *U fhandekanywa ha mbadelo dza vhashumi*\n\n*Gross Salary:* R{gross}\n• PAYE: R{paye}\n• UIF (employee): R{uif_ee}\n\n*Net Pay: R{net}*\n\n*muthelo wa SARS:*\n• UIF (employer): R{uif_er}\n• SDL: R{sdl}\n\n*Total Cost to You: R{total}*\n\nDuvha ṱa u fhedzisa ndi dzi 7 dza ṅwedzi muṅwe na muṅwe.\n\nkha vha ṅwale *MENU* u humela murahu.`,
    STORE_MENU:     `🛒 *KasiStore*\n\n1️⃣ Engedzani zwi rengiswa (product)\n2️⃣ Sedzani zwithu zwanga\n3️⃣  Kha vha wane linki ya bindu ḽavho\n\nKha vha ṅwale *MENU* u humela murahu.`,    STORE_ADD_NAME: `📦 Dzina ḽa tshithu ndi ḽani?`,
    STORE_ADD_PRICE: `💰 Kha ṅwale mutengo? (e.g. 150)`,
    STORE_ADD_DESC: `📝 Kha ṅwale ṱhaluso pfufhi (kana ṅwalani SKIP)`,
    STORE_INVALID_PRICE: `Kha vha ṅwale tshelede yo teaho (e.g. 150)`,
    CREDIT_MENU:    `💰 *KasiCredit — Ndugelo ya Tshelede*\n\n1️⃣ Sedzani arali ni tendelwa\n2️⃣ Itani ndugelo zwino\n\nKha vha ṅwale *MENU* u humela murahu.`,
