...
export const MESSAGES: Record<string, Record<string, string>> = {
  ...
  en: {
    ...
    STORE_MENU:     `🛒 *KasiStore — My Online Store*\n\n3️⃣ Get my store link\n\nType *MENU* to go back.`,
  ...
  xh: {
    ...
    STORE_MENU:     `🛒 *KasiStore — Ivenkile Yam*\n\n3️⃣ Fumana ikhonkco levenkile yam\n\nTayipha *MENU* ukubuyela.`,
  ...
  st: {
    ...
    STORE_MENU:     `🛒 *KasiStore — Lebenkele La Ka*\n\n3️⃣ Fumana linki ya lebenkele la ka\n\nTaepa *MENU* ho kgutla.`,
  ...
  af: {
    ...
    STORE_MENU:     `🛒 *KasiStore — My Aanlynwinkel*\n\n3️⃣ Kry my winkelskakel\n\nTik *MENU* om terug te gaan.`,
  ...
  ve: {
    ...
    STORE_MENU:     `🛒 *KasiStore — Vhengele Ḽanga ḽa Online*\n\n3️⃣ Wanani linki ya vhengele ḽavho\n\nKha vha ṅwale *MENU* u humela murahu.`,
